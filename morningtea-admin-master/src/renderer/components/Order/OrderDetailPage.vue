            ...
            <div class="form-table-box">
                <el-tabs v-model="activeName" @tab-click="handleClick">
                    <el-tab-pane label="订单信息" name="first">
                        <div class="content-title marginTop">下单人信息：</div>
                        <el-table :data="addressData" style="width: 80%" border stripe>
                            ...
                            <el-table-column prop="mobile" label="用户手机" width="140"></el-table-column>
                            <el-table-column prop="postscript" label="用户备注" width="230"></el-table-column>
                        ...
                        <div class="content-title marginTop">菜品信息：</div>
                        <el-table :data="infoForm.goodsList" style="width: 100%" border stripe>
                            <el-table-column prop="goods_name" label="菜品名称"></el-table-column>
                            <el-table-column prop="retail_price" label="售价" width="120"></el-table-column>
                        ...
                        <div class="detail-wrap">
                            ...
                            <div class="total-price"> 合计：¥{{infoForm.actual_price}}</div>
                        </div>
                        <div class="memo-wrap">
