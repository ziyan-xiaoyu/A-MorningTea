    ...
    <div class="content-page">
        ...
        <div class="content-main">
            <el-tabs v-model="activeName" @tab-click="handleClick">
                ...
                <el-tab-pane label="未完成" name="third"></el-tab-pane>
                <el-tab-pane label="已取消" name="fourth"></el-tab-pane>
            </el-tabs>
            <div class="filter-box">
                <el-form :inline="true" :model="filterForm" class="demo-form-inline">
                    <el-form-item label="订单编号">
                        <el-input class="filter-input" v-model="filterForm.order_sn" placeholder="请输入订单编号"></el-input>
                    </el-form-item>
                    <el-form-item label="下单人信息">
                        <el-input class="filter-input" v-model="filterForm.consignee" placeholder="请输入下单人信息"></el-input>
                    </el-form-item>
                ...
                <el-checkbox-group v-model="checkedCities" @change="handleCheckedCitiesChange">
                    <div v-for="item in tableData" class="list-wrap clearfix">
                        <div class="header clearfix">
                            ...
                            <div class="right">
                                <div class="goods-num">共{{item.goodsCount}}件菜品</div>
            ...
            <div class="form-table-box">
                <el-table :data="tableData" style="width: 100%" stripe>
                    ...
                    <el-table-column prop="sell_volume" label="订单金额" width="120"></el-table-column>
                    <el-table-column prop="sell_volume" label="下单人信息" width="130"></el-table-column>
                    <el-table-column prop="sell_volume" label="订单状态" width="130"></el-table-column>
                    <el-table-column prop="goods_number" label="下单时间" width="130" sortable></el-table-column>
                    
                    <el-table-column label="操作">
                        <template scope="scope">
                            <el-button size="small" @click="handleRowEdit(scope.$index, scope.row) ">查看详情</el-button>
