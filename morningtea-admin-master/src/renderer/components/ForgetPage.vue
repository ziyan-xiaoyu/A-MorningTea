        ...
        <div class="login-box">
            ...
            <div class="body">
                ...
                <el-form ref="form" :model="form" :rules="rules" label-position="top">
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="startLogin" :loading="loading" style="width: 100%;">{{'注册'}}</el-button>
                    </el-form-item>
                    <el-form-item>
                        <el-button type="primary" @click="startLogin" :loading="loading" style="width: 100%;">{{'忘记密码'}}</el-button>
                    </el-form-item>
                </el-form>
