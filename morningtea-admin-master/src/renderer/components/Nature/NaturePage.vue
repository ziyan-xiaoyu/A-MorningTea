    ...
    <div class="content-page">
        <div class="content-nav">
            <el-breadcrumb class="breadcrumb" separator="/">
                <el-breadcrumb-item>菜品设置</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="content-main">
            <el-tabs v-model="activeName" @tab-click="handleClick">
                <el-tab-pane label="菜品分类" name="first"></el-tab-pane>
                <el-tab-pane label="菜品型号" name="second"></el-tab-pane>
            </el-tabs>
