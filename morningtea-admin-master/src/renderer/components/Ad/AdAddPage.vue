                ...
                <el-form ref="infoForm" :rules="infoRules" :model="infoForm" label-width="120px">
                    ...
                    <el-form-item label="菜品类型">
                        <el-radio-group v-model="infoForm.link_type">
                            <el-radio :label="0">菜品id</el-radio>
                    ...
                    <el-form-item label="菜品id" prop="link" v-if="infoForm.link_type == 0">
                        ...
                        >
                            <el-table :data="chooseRelateGoods" stripe style="width: 100%">
                                ...
                                <el-table-column prop="list_pic_url" label="菜品图片" width="120">
                                    <template scope="scope">
                                        <img :src="scope.row.list_pic_url" alt="" style="width: 40px;height: 40px">
                                    </template>
                                </el-table-column>
                                <el-table-column prop="name" label="菜品名称" width="300px"></el-table-column>
                            ...
                            <el-button slot="reference" type="primary" @click="relateGoodsClick">添加关联菜品</el-button>
                        </el-popover>
                    </el-form-item>
