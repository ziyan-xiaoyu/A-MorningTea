    ...
    <div class="content-page">
        <div class="content-nav">
            <el-breadcrumb class="breadcrumb" separator="/">
                <el-breadcrumb-item>广式早茶--后台管理系统</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
            ...
            <div class="header clearfix">
                <el-card class="box-card card-blue">
                    <router-link class="link-color" :to="{ path: '/dashboard/goods' }">
                        ...
                        <h1>{{'23'}}</h1>
                        <div class="text item">菜品总数</div>
                    </router-link>
                </el-card>
                <el-card class="box-card card-orange">
                    <router-link class="link-color" :to="{ path: '/dashboard/order' }">
                        <h1>{{'1123'}}</h1>
                        <div class="text item">订单量</div>
                    </router-link>
                </el-card>
                <el-card class="box-card card-green">
                    <router-link class="link-color"  :to="{ path: '/dashboard/money' }">
                        <h1>{{'239,234'}}</h1>
                        <div class="text item">总收入</div>
                    </router-link>
                </el-card>
            </div>
            <div class="main">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //             type: 'value'
            //         },
            //         series: [{data: [820, 1032, 901, 634, 1290, 1330, 1020],type: 'line'},
            //                  {data: [628, 817, 1034, 1401, 920, 813, 1000],type: 'line'},
            //                  {data: [712, 910, 1041, 1501, 1107, 835, 910],type: 'line'}
            //         ],
            //     }
            // },
        },
