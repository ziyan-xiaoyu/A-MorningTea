    ...
    <div class="content-page">
        <div class="content-nav">
            ...
            <div class="operation-nav">
                <router-link to="/dashboard/goods/add">
                    <el-button type="primary" icon="plus" size="small">添加菜品</el-button>
                </router-link>
            </div>
        </div>
        <div class="content-main">
            ...
            <el-tabs v-model="activeName" @tab-click="handleClick">
                ...
                <!-- <el-tab-pane label="早茶上新" name="second"></el-tab-pane>
                <el-tab-pane label="早茶经典" name="third"></el-tab-pane>
                <el-tab-pane label="香香糯糯" name="fourth"></el-tab-pane>
                <el-tab-pane label="无肉不欢" name="fifth"></el-tab-pane>
                <el-tab-pane label="软软馒头" name="sixth"></el-tab-pane>
                <el-tab-pane label="灌汤小笼" name="seventh"></el-tab-pane>
                <el-tab-pane label="马拉糕" name="eighth"></el-tab-pane>
                <el-tab-pane label="粤式点心" name="ninth"></el-tab-pane>
                <el-tab-pane label="你的早茶" name="tenth"></el-tab-pane> -->
            </el-tabs>
            <div class="filter-box">
                <el-form :inline="true" :model="filterForm" class="form-inline">
                    <el-form-item label="菜品名称">
                        <el-input size="small" v-model="filterForm.name" placeholder="菜品名称"></el-input>
                    </el-form-item>
                    <el-form-item>
            ...
            <div class="form-table-box">
                <el-table :data="tableData" style="width: 100%" stripe>
                    <el-table-column type="expand">
                        <template slot-scope="props">
                            <el-table :data="props.row.product" style="width: 100%" stripe>
                                ...
                                <el-table-column prop="goods_sn" label="菜品编号" width="140">
                                    <template scope="scope">
                                        <el-input @blur="checkSkuOnly(scope.$index, scope.row)" size="mini"
                                                  v-model="scope.row.goods_sn" placeholder="菜品SKU"></el-input>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="goods_aka" label="菜品名称" width="160">
                                    <template scope="scope">
                                        <el-input size="mini" v-model="scope.row.goods_name"
                                                  placeholder="简称"></el-input>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="value" label="规格" width="140">
                                    <template scope="scope">
                                ...
                                <el-table-column prop="retail_price" label="售价(元)" width="90">
                                    <template scope="scope">
                                        <el-input size="mini" v-model="scope.row.retail_price"
                                                  placeholder="零售"></el-input>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="goods_weight" label="分量(g)" width="90">
                                    <template scope="scope">
                                        <el-input size="mini" v-model="scope.row.goods_weight"
                                                  placeholder="重量"></el-input>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="goods_number" label="余量" width="90">
                                    <template scope="scope">
                    ...
                    <el-table-column prop="list_pic_url" label="菜品图片" width="80">
                        <template scope="scope">
                    ...
                    <el-table-column prop="name" label="菜品名称"></el-table-column>
                    <el-table-column prop="sell_volume" label="销量" width="80" sortable></el-table-column>
                    <el-table-column prop="goods_number" label="价格" width="80" sortable></el-table-column>
                    <el-table-column prop="goods_number" label="分类" width="80" sortable></el-table-column>
                    <el-table-column label="上架" width="80">
                        <template scope="scope">
                            <el-switch
                                    v-model="scope.row.is_on_sale"
