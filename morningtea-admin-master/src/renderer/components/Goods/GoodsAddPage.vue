    ...
    <div class="content-page">
        <div class="content-nav">
            <el-breadcrumb class="breadcrumb" separator="/">
                <el-breadcrumb-item :to="{ name: 'goods' }">菜品管理</el-breadcrumb-item>
                <el-breadcrumb-item>{{infoForm.id ? '编辑菜品' : '添加菜品'}}</el-breadcrumb-item>
            </el-breadcrumb>
        ...
        <div class="content-main">
            <div class="form-table-box">
                <el-form ref="infoForm" :rules="infoRules" :model="infoForm" label-width="120px">
                    ...
                    <el-form-item  label="菜品分类" prop="goods_kind">
                        <el-select class="el-select-class" v-model="cateId" placeholder="选择分类">
                            <el-option
                                    v-for="item in cateOptions" :key="item.value" :label="item.label" :value="item.value">
                            </el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="菜品标签" prop="goods_label">
                        <el-input v-model="infoForm.sell_volume"></el-input>
                    </el-form-item>
                    <el-form-item label="菜品定价" prop="goods_price">
                        <el-input v-model="infoForm.sell_volume"></el-input>
                    </el-form-item>
                    <el-form-item label="菜品单位" prop="goods_unit">
                        <el-input v-model="infoForm.goods_unit"></el-input>
                        <div class="form-tip">如：件、包、袋</div>
                    </el-form-item>
                    <el-form-item label="菜品状态">
                        <el-switch active-text="在售" inactive-text="售罄" active-value="1" inactive-value="0" v-model="infoForm.is_on_sale"></el-switch>
                    </el-form-item>


                    <el-form-item label="菜品图片" prop="list_pic_url" v-if="infoForm.list_pic_url"
                    ...
                    <el-form-item label="菜品轮播图" prop="goods_sn" v-if="infoForm.id">
                        <el-upload
                                name="file"
                                class="upload-demo"
                                :action="qiniuZone"
                    ...
                    <el-form-item label="菜品详情" prop="goods_desc">
                    ...
                    <el-form-item label="菜品简介" prop="goods_brief">
                        <el-input type="textarea" v-model="infoForm.goods_brief" :rows="3"></el-input>
                        <div class="form-tip"></div>
                    </el-form-item>
                    <el-form-item label="菜品单位" prop="goods_unit">
                    ...
                    <el-form-item>
                        ...
                        <!-- <el-button type="danger" class="float-right" @click="onCopyGood">复制菜品</el-button> -->
